# DATA Daemon — Lemon Squeezy listing copy
...
## Product name
DATA Daemon — Your Self-Hosted AI Command Center
...
DATA needs no API keys from us. It drives the official command-line tool for whichever provider you choose and logs in with *your* account:
...
3. New Product → Digital download → upload `dist\DATA-v1.0.17.zip`.
4. Paste the name, descriptions, price ($39 one-time), and requirements from above.
